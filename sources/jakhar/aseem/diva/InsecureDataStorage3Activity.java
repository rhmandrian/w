...
public class InsecureDataStorage3Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) C0319R.layout.activity_insecure_data_storage3);
    }

    public void saveCredentials(View view) {
        EditText usr = (EditText) findViewById(C0319R.C0321id.ids3Usr);
        EditText pwd = (EditText) findViewById(C0319R.C0321id.ids3Pwd);
        try {
