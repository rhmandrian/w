...
/* renamed from: android.support.v7.internal.widget.ButtonBarLayout */
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, C0225R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0225R.styleable.ButtonBarLayout_allowStacking, false);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0225R.C0227id.spacer);
        if (spacer != null) {
