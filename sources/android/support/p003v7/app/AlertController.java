...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0225R.styleable.AlertDialog, C0225R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0225R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0225R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0225R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0225R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0225R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0225R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    }
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0225R.C0227id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0225R.C0227id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0225R.C0227id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0225R.C0227id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0225R.C0227id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0225R.C0227id.topPanel);
        View customContentPanel = customPanel.findViewById(C0225R.C0227id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0225R.C0227id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null) {
            View spacer = contentPanel.findViewById(C0225R.C0227id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0225R.C0227id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0225R.C0227id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0225R.C0227id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0225R.C0227id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0225R.C0227id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0225R.C0227id.scrollView);
